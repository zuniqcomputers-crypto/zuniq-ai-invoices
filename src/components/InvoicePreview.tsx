      ...
      <div className="p-6 md:p-10 space-y-8">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-y border-gray-200 text-left text-gray-500 text-xs uppercase tracking-wider">
            ...
            <tbody className="divide-y divide-gray-50">
              {data.items.length === 0 ? (
                <tr>
                  <td colSpan={4} className="py-8 text-center text-gray-300 italic">No items added yet</td>
                </tr>
              ) : (
