...
/* ---------- Edit Form (same as in new page, but defined here for reuse) ---------- */
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="number" value={data.tax_percentage} onChange={(e) => updateField("tax_percentage", parseFloat(e.target.value) || 0)} className="w-full h-10 px-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" />
        </div>
        <div>
          <label className="block text-xs font-semibold text-gray-500 mb-1">Discount</label>
          <input type="number" value={data.discount} onChange={(e) => updateField("discount", parseFloat(e.target.value) || 0)} className="w-full h-10 px-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" />
        </div>
      </div>
